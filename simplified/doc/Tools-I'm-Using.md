...
* Visual Code 1.90.1 (_for PowerShell Development, MD editing._)
...
* PowerShell Core 7.5.0 preview 2 (_Got it to work, though UNO is probably out. Switched to straight LibreOffice_)
* soffice 24.2.0.3 (_executable part of LibreOffice. Used to convert calc sheets to csv (UTF8)._)
...
* PowerShell 2024.3.2 (pre-release)
...
* Bracket Lens 1.5.3                         (_Works, but needed to edit it's config and 1) add support for powershell comments and 2) take out bracket detection._)
...
* Quick Replace In Selection 1.2.3           (_Only replacer that works in column selector?_)
...
* DBeaver 24.0.2 Community       (_latest always, Oct 2023, for browsing data, DDL extract, adding columns, scripting. WARNING: Wipes out all extensions every install._)
  * WakaTime 5.1.0               (_Pushes my work time to Waka dashboard online_)
* pgAdmin 4.7.8                  (_latest always) (2023) (for not table work, just types, enums, ddl creation, most can be done in DBeaver_)
* pg_dump for DDL                (_only tool that works to dump ALL objects and types._)
* psqlODBC 16.00.0000
* psqlODBC 13.02.0000-1
* psqlODBC_x64 15.00.0000        (_Huh? Which installed app is used??_)

#### File Gathering

* qBitTorrent 4.6.5                (_for I2P - GNU General Public License, version 3 or GPLv3+ \* Qt 6.4.2 \* libtorrent-rasterbar 1.2.19.0 \* Boost 1.83.0 \* OpenSSL 1.1.1w \* zlib 1.3_)
* YouTube (on FireFox)
...
* Free Video Editor 1.0.18 (_Used it a few times to concatenate split up VOB files. See MakeMKV for splitting VOBs into episodes._)

#### Video Metadata

* Get-MediaInfo 3.7     (_Fantastic! Granted, lotta work cleaning up output, but massive movie metadata!_)
* MediaInfo 24.04 (GUI) (_Helps to see what I'm missin'_)
* WebUI API             (_part of qBitTorrent. I pull down active status of torrents. Still needs work to determine what information to track._)
...
* Time Adjuster 3.1     (_Fix subtitle sync._)
